...
2. Почни з `00-Methodology/Preparation-Plan.md`: він задає ритм підготовки, критерії готовності й журнал слабких місць.
3. Заповнюй нотатки **своїми словами** під час проходження модулів — не копіюй чітшіти цілком.
4. Кожну команду оформлюй за шаблоном `00-Methodology/_Command-Note-Template.md`.
5. Під час іспиту навігація йде по фазах атаки, а не по модулях.
...
## Карта вольту
- `00-Methodology` — план підготовки, чеклисти, тайм-менеджмент, шаблон нотатки, **Bypasses** (AMSI/AppLocker)
